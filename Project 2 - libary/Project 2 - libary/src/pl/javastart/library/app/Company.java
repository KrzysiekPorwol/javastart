...
import pl.javastart.library.model.Employment;
...
public class Company {
  public static void main(String[] args) {
    ...
    employees.stream()
          .filter(Employee::ChangeEmployment)
...
//          .ifPresent(emp -> System.out.println("Pracownik o najdłuższym imieniu i nazwisku to " + emp));
  ...
  private static void printLongestName(String name) {
    System.out.println("Pracownik o najdłuższym imieniu i nazwisku to " + name);
  }

  private static Optional<String> employeeWithLongestName(List<Employee> employees) {
    return employees.stream()
          .map(Employee::writeEmployeeName)
